 ...
 */
public class FunctionEndpointImpl<TResult>
        extends AbstractTriggerEndpoint
        implements FunctionEndpoint<TResult> {
     ...
     */
    public FunctionEndpointImpl(Endpoint parent, URI relativeUri, Class<TResult> resultType) {
     ...
     * @param resultType The type of entity the endpoint returns as output.
     */
    public FunctionEndpointImpl(Endpoint parent, String relativeUri, Class<TResult> resultType) {
        super(parent, relativeUri);
        this.resultType = resultType;
    }
