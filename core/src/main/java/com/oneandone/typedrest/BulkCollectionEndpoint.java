 ...
 * <code>TElementEndpoint</code>s with bulk create and replace
 * support.
 *
 ...
 */
public interface BulkCollectionEndpoint<TEntity, TElementEndpoint extends ElementEndpoint<TEntity>>
